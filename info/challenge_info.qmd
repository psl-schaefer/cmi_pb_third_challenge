...
- Model evaluation will happen in two steps:
	- First, we will choose the Spearman rank correlation coefficient as an evaluation metric to compare the predicted ranked list (_p_) for each task (_t)_, and n subjects (n=54 for the set of challenge dataset subjects), _Rp,t = (rp,1, rp,2, …, rp,n)_ against a ground truth (_g_) ranked list _Rg,t = (rg,1, rg,2, …, rg,n)_.
