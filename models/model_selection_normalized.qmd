...
output_dir = file.path("..", "results", "model_selection_normalized")
...
prediction_specs <- list(
  "task_11" = list(
    "model" = "rf",
    "feature_set" = "pbmc_gene_expression+plasma_ab_titer+t_cell_activation+metadata+baseline",
    "table_col" = "1.1) IgG-PT-D14-titer-Rank"
  ),
  "task_12" = list(
    "model" = "lasso",
    "feature_set" = "pbmc_gene_expression+t_cell_polarization+metadata+baseline",
  ...
  "task_31" = list(
    "model" = "rf",
    "feature_set" = "pbmc_cell_frequency+pbmc_gene_expression+plasma_cytokine_concentration_by_legendplex+t_cell_activation+t_cell_polarization+metadata+baseline",
    "table_col" = "3.1) CCL3-D3-Rank"
  ),
  "task_32" = list(
    "model" = "elnet",
    "feature_set" = "pbmc_gene_expression_pca+t_cell_activation_pca+t_cell_polarization_pca+metadata+baseline",
    "table_col" = "3.2) CCL3-D3-FC-Rank"
  ),
  "task_41" = list(
    "model" = "elnet",
    "feature_set" = "pbmc_gene_expression+plasma_cytokine_concentration_by_legendplex+t_cell_activation+metadata+baseline",
...
#load(file=file.path(output_dir, "2024-10-23_model_selection_session.RData"))
```
