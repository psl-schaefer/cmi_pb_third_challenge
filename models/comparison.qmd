...
purrr::map(all_settings, function(setting_a) {
  ...
  dplyr::mutate(setting_a = factor(setting_a, levels=c("default", "normalized", "integrated"))) %>%
  dplyr::mutate(setting_b = factor(setting_b, levels=c("default", "normalized", "integrated"))) %>%
